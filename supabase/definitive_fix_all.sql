-- ============================================================================
-- DEFINITIVE FIX - Complete Removal of Users Table Dependencies
...
DECLARE
    r RECORD;
BEGIN
    -- Drop specific known FK constraints
    ...
    RAISE NOTICE '✓ Dropped specific FK constraints';

    -- Find and drop any remaining FK constraints to users table
    FOR r IN
        SELECT
            tc.table_name,
            tc.constraint_name
...
-- ============================================================================
-- STEP 3: Add Required Unique Constraints
-- ============================================================================
...
RAISE NOTICE '✓ Added unique constraints';

-- ============================================================================
-- STEP 4: Drop ALL Versions of provision_stakeholder_v2 Function
-- ============================================================================

-- Try multiple drop approaches to ensure all versions are removed
...
RAISE NOTICE '✓ Dropped all versions of provision_stakeholder_v2';

-- ============================================================================
-- STEP 5: Create NEW provision_stakeholder_v2 Function (NO created_by)
-- ============================================================================
        ...
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workflow_instances' AND column_name = 'app_uuid') THEN
            ...
            IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'activities') THEN
                INSERT INTO activities (
                    ...
                    'ACCEPT_TERMS_' || v_stakeholder_id::text,
...
RAISE NOTICE '✓ Created new provision_stakeholder_v2 function';
...
BEGIN
    ...
    RAISE NOTICE '✓ Recreated provision_stakeholder_v2 function';
    RAISE NOTICE '========================================';
