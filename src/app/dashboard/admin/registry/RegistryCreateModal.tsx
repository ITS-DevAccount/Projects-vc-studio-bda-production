/**
 * Registry Create Modal Component
...
import { REGISTRY_TYPES, DEFAULT_REGISTRY_VALUES } from '@/lib/types/registry';
...
export function RegistryCreateModal({ onClose, onCreated }: RegistryCreateModalProps) {
  const [formData, setFormData] = useState<CreateRegistryEntryInput>({
    component_code: '',
    component_name: '',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b px-6 py-4">
          <h2 className="text-xl font-bold text-gray-900">Create Registry Entry</h2>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Component Code * <span className="text-gray-500 font-normal">(unique identifier)</span>
                </label>
                <input
                  type="text"
                  required
