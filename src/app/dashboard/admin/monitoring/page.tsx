  ...
  const sections = [
    {
      id: 'monitoring',
      label: 'Monitoring',
      description: 'Monitor workflow execution, analyze performance, and generate compliance reports',
      icon: BarChart3,
      href: '/dashboard/admin/monitoring/dashboard'
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div>
          ...
          <p className="text-gray-600 mb-8">Monitor workflow execution and performance</p>
        </div>
